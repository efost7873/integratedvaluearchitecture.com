...
<main>
  ...
  <section style="margin-bottom: 48px;">
    ...
    <ul>
      ...
      <li>work that moves inconsistently across teams</li>
      <li>capacity that collapses under pressure</li>
      <li>coordination that depends on specific people being available</li>
      <li>problems that return in new forms</li>
  ...
  <section style="margin-bottom: 48px;">
    ...
    <ul>
      ...
      <li>how authority and responsibility are distributed</li>
