...
<main>
  ...
  <section style="margin-bottom: 48px;">
    ...
    <div style="display: flex; gap: 32px; align-items: flex-start; flex-wrap: wrap; margin-bottom: 32px;">
      ...
      <div style="flex: 0 0 260px;">
        <img src="{{ site.baseurl }}/assets/images/evan.jpg"
             alt="Evan Foster"
  ...
  <section style="margin-bottom: 48px;">
    ...
    <p>
      I hold three degrees and a graduate certificate from the University of Illinois at Springfield. My work spans environmental health, statewide public health programs, scientific operations, and organizational governance. In each environment, I saw the same structural patterns that IVA now makes visible.
    </p>
  ...
  <section style="margin-top: 48px;">
    ...
    <img src="{{ site.baseurl }}/assets/images/signature.png"
         alt="Signature"
